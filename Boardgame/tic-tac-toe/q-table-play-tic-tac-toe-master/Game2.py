...
# 读取Q表格
with open('C:/Users/周靖雅/Desktop/RL/N子棋/q-table-play-tic-tac-toe-master/q-table-play-tic-tac-toe-master/Q_table_dict.pkl', 'rb') as f:
...
class UserInterface():
    def __init__(self):
        ...
        # 颜色类
        self.BrightGreen = (221, 255, 227) # 亮绿
        self.DarkGray = (169, 169, 169) # 深灰
        self.LightSkyBlue = (135, 206, 250) # 淡蓝
        self.PaleVioletRed = (219, 112, 147) # 苍紫红
        self.Black = (0, 0, 0) # 黑色
        self.Crimson = (220, 20, 60) # 深红
        
        # 常用属性类
        self.BGCOLOR = self.BrightGreen # 背景色
        self.INTERVAL = 1 # 行动间隔    self.INTERVAL = 0.5
        self.FPS = 40 # 帧数
        ...
        # 字体类
        self.font = pygame.font.Font('C:/Users/周靖雅/Desktop/RL/N子棋/q-table-play-tic-tac-toe-master/q-table-play-tic-tac-toe-master/texture/arialbd.ttf', self.SIZE_S)
        
        self.font1 = pygame.font.Font('C:/Users/周靖雅/Desktop/RL/N子棋/q-table-play-tic-tac-toe-master/q-table-play-tic-tac-toe-master/texture/BD_Cartoon_Shout.ttf', 20)
        self.font2 = pygame.font.Font('C:/Users/周靖雅/Desktop/RL/N子棋/q-table-play-tic-tac-toe-master/q-table-play-tic-tac-toe-master/texture/arialbd.ttf', 20)
        #self.font1 = pygame.font.SysFont('arial', 20)  # 使用 Arial 字体
        #self.font2 = pygame.font.SysFont('arial', 20)  # 使用 Arial 字体
        
        # 图片类
        self.img_circle = pygame.image.load('C:/Users/周靖雅/Desktop/RL/N子棋/q-table-play-tic-tac-toe-master/q-table-play-tic-tac-toe-master/texture/circle.png').convert_alpha() # convert_alpha() 加载图片去黑边
        self.img_circle = pygame.transform.smoothscale(self.img_circle, (self.SIZE_M, self.SIZE_M))
        self.img_cross = pygame.image.load('C:/Users/周靖雅/Desktop/RL/N子棋/q-table-play-tic-tac-toe-master/q-table-play-tic-tac-toe-master/texture/cross.png').convert_alpha()
        self.img_cross = pygame.transform.smoothscale(self.img_cross, (self.SIZE_M, self.SIZE_M))
        self.img_pick = pygame.image.load('C:/Users/周靖雅/Desktop/RL/N子棋/q-table-play-tic-tac-toe-master/q-table-play-tic-tac-toe-master/texture/pick.png').convert_alpha()
        self.img_pick = pygame.transform.smoothscale(self.img_pick, (35, 35))
        
        # 文字类
        self.player1_text = self.font1.render('PLAYER1', True, self.LightSkyBlue) # True: 抗锯齿
        self.player2_text = self.font1.render('PLAYER2', True, self.PaleVioletRed)
        ...
        self.start_text = self.font1.render('START', True, self.Crimson)
    ...
    def render(self):
        ...
        # 显示分隔线
        for i in range(4):
            pygame.draw.line(self.window, self.DarkGray, (50, 50 + i * self.SIZE_L), (50 + 3 * self.SIZE_L, 50 + i * self.SIZE_L), 8)
            pygame.draw.line(self.window, self.DarkGray, (50 + i * self.SIZE_L, 50 + 3 * self.SIZE_L), (50 + i * self.SIZE_L, 50), 8)
