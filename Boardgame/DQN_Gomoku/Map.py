...
btnAuto = tk.Button(top, text="Restart or autowalk 1 time", command=AutoPlayOnce)
btnAuto.pack()
# 画布与鼠标左键进行绑定
...
btnAuto = tk.Button(top, text="Play a game automatically", command=AutoPlayOne)
btnAuto.pack()
